    ...
    return (
        ...
        <div className=' py-3 flex'>
            ...
            <div className='flex flex-col ml-2 gap-2'>
                <span className='font-bold text-sm'>Emily Jones</span>
                <span className=' font-light text-sm'>@EmilyJ</span>
            </div>
        </div>
        ...
        <div className='flex flex-col md:flex-row'>
            <div className='flex space-x-2 '>
                <img src = {product} className='w-[130px] h-[130px] rounded-sm' />
                <div className='flex flex-col space-y-2  '>
                    <p className='max-w-[350px]'>UK POSTAGE - DISCOUNT ON BUNDLES
                Amazing brown distressed retro leather...</p>
